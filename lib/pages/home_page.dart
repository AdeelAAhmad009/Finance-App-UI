...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const cardDetails = [
      ...
      CardDetail(cardBgAsset: 'assets/card3bg.jpg', balance: '848,900.30', cardNumber: '3486'),
      CardDetail(cardBgAsset: 'assets/card2bg.jpg', balance: '350,800.90', cardNumber: '6343'),
    ];
    final contactsList = [
      Contact(
            ...
            child: CardSwiper(
              ...
              cardBuilder: (context, index, horizontalOffsetPercentage, verticalOffsetPercentage) {
                ...
                return GestureDetector(
                  onTap: () => Navigator.push(context, HistoryPage.route(cardDetail: cardDetail)),
                  child: BankCard(
              ...
              return FadeInAnimation(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: themeData.getTheme() == themeData.darkTheme ? Colors.white12 : contact.color,
                    borderRadius: BorderRadius.circular(20),
                  ),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      CircleAvatar(maxRadius: 25, foregroundImage: AssetImage(contact.profileAsset)),
